...
def create_main_window(settings):
    ...
    layout = [[sg.Menu(menu_def)],
              [sg.Text('Text to Binary Converter', size=(45,1), font=('Helvetica', 11)), sg.Button('', key='paypal', size=(12,1), font=('Helvetica', 9), button_color=(sg.theme_background_color(), sg.theme_background_color()),
                           image_filename='paypal.png', image_size=(120, 80), image_subsample=2, border_width=0),
                 sg.Button('', key='bitcoin', size=(12,1), font=('Helvetica', 9), button_color=(sg.theme_background_color(), sg.theme_background_color()),
                           image_filename='bitcoin.png', image_size=(120, 80), image_subsample=2, border_width=0)],      
